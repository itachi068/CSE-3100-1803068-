        ...
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">RUET campus</div>
              <div class="text-two">Rajshahi, Bangladesh</div>
            </div>
            <div class="phone details">
              <i class="fas fa-phone-alt"></i>
              <div class="topic">Phone</div>
              <br>
              <div class="text-one">016XX-XXXXXX</div>
            </div>
            <div class="email details">
              <i class="fas fa-envelope"></i>
              <div class="topic">Email</div>
              <br>
              <div class="text-one">Akanto Roy</div>
              <div class="text-two">akantoroy14524@gmail.com</div>
            </div>
          </div>
          ...
          <form action="mailto:akantoroy14524@gmail.com" enctype="text/plain" method="post">
            <div class="input-box">
